...
<nav class="navbar navbar-fixed-top" style="background-color: #ee7614;">
  <div class="container-fluid " style="position: absolute; margin-left: 85px;">
    ...
    <li><img class="image" border="0" src="wikrama-logo.png"  width="55px" style=" margin-left: 40px; margin: 1px; padding: 0px color:white;"></li>
    </ul></b>
  </div>
</nav>
...
<div class="content1" id="content1">
    ...
    <img src="wikrama-logo.png" style="position:absolute; margin-left:87%; height: 60px; width: 60px; margin-top: 13%;  background-color: #FFFFFF; border: 8.14286px solid #FFFFFF;
                                            filter: drop-shadow(0.771459px 6.17167px 46.2875px rgba(0, 0, 0, 0.1));  border-radius: 195px;  width: -15%;">

    <div class="ccardd">
      <div class="ccard">
        <img src="daun.png" alt="" style="width: 45px; height: 45px; ">
        <p>Lingkungan Terjaga.</p>
      </div>

      <div class="ccard" style="margin-top: 28px;">
        <img src="vector.png" alt="" style="width: 45px; height: 45px; border-radius: 0;">
        <p>Kapasitas Besar.</p>
      </div>

      <div class="ccard" style="margin-top: 28px;">
        <img src="qur'an.png" alt="" style="width: 45px; height: 45px; border-radius: 0;">
        <p>Al-Qur'an Gratis.</p>
      </div>
    </div> 

    <img src="masjid.png" style="margin-top: 25px;"/>
...
<div id="carouselExampleIndicators" class="carousel slide" style="margin-top:50px; margin-left:65px; margin-right:50px; ">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="wk1.jpg" class="d-block w-100" style="height:450px;border-radius:20px;">
    </div>
    <div class="carousel-item">
      <img src="wk2.png" class="d-block w-100" style="height:450px;border-radius:20px;">
    </div>
    <div class="carousel-item">
      <img src="wk3.jpg" class="d-block w-100" style="height:450px; border-radius:20px;">
    </div>
  </div>
...
<div class="font">
  ...
  <div class="tangan" style="margin-top: 30%;">
      <img src="tangan.png" style="margin-top: 15px; margin-bottom: 120px;" >
  </div>
  <div class="content">
            <div class="container">
                <div class="cad">
...
<!-- table data -->
<div style="overflow: auto; width: 1310px; height: 500px;">
<table border="1">
        <thead>
            <tr>
                <th>No. </th>
...
<div class="content4" id="content4">
  <div class="font">
    ...
    <div class="deskripsi">
        ...
        <div class="gall">
            <img src="gambar1.jpg" alt="Cinque Terre">
          
            <img src="gambar2.png" alt="Forest">
        
            <img src="gambar3.png" alt="Northern Lights">

            <div class="gal">
            <img src="gambar4.png" alt="Cinque Terre">
          
            <img src="gambar5.png" alt="Forest">
        
            <img src="gambar6.png" alt="Northern Lights">
            </div>
            </div>
  </div>
</div>
...
<footer class="footer">
  <div class="footer-img" style="display: flex;">
    <img src="wikrama-logo.png" alt="" style="width: 45px; height: 45px; margin-top: 40px;">
        ...
        <div class="roww">
            ...
            <div class="footer-col" style="margin-top: -40px;">
                ...
                <form action="mailto: yogadwipramana@smkwikama.sch.id" method="post" enctyype="text/plain">
                        ...
                        <div class="mb-3"  style="margin-top: -15px;"> 
                            <input type="text" class="form-control" id="pesan" placeholder="Pesan Anda" style="width: 288px; height: 138px;">
                        </div><br>
